...
def addNode(f, node):
    ...
    node2Face1 = edge1_1.getNextEdge().node
    node3Face1 = edge1_1.getNextEdge().getNextEdge().node
    face1 = Face.Face(node1Face1, node2Face1, node3Face1, edge1_1)
    
    # Create face 2
    node1Face2 = edge2_1.node
    node2Face2 = edge2_1.getNextEdge().node
    node3Face2 = edge2_1.getNextEdge().getNextEdge().node
    face2 = Face.Face(node1Face2, node2Face2, node3Face2, edge2_1)
    
    node1Face3 = edge3_1.node
    node2Face3 = edge3_1.getNextEdge().node
    node3Face3 = edge3_1.getNextEdge().getNextEdge().node
...
def flipEdge(e):
    ...
    node1 = e1.getNextEdge().node
    node2 = e2.getNextEdge().node
    ...
    node2Face1 = e1_1.getNextEdge().node
    node3Face1 = e1_1.getNextEdge().getNextEdge().node
    newFace1 = Face.Face(node1Face1, node2Face1, node3Face1, e1_1)
    
    # Create face 2
    node1Face2 = e2_1.node
    node2Face2 = e2_1.getNextEdge().node
    node3Face2 = e2_1.getNextEdge().getNextEdge().node
